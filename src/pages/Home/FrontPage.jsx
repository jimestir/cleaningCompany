import frontPageOne from '../../assets/p2.jpg'
        ...
        <div
          ...
          <div class='bg-[#ffffffc6] ml-[100px]  h-fit p-[60px] rounded-md w-[800px] max-sm:p-3 max-sm:ml-0 max-sm:w-[280px] '>
            ...
            <p class='text-gray-500 text-lg mb-8 max-sm:text-[15px] max-sm:hidden'>
              Transformamos tus espacios en lugares impecables, para que tú solo
              te preocupes por disfrutarlos.
            </p>
            <div class='flex space-x-4 max-sm:space-x-0'>
              <button
                onClick={() => scrollToIdContact('contact')}
                href='#'
              ...
              <a
                onClick={() => scrollToIdServies('services')}
